...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002754048161').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ZoroverseX') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ZoroverseX') # Owner link for the bot
