...
PICS = (environ.get('PICS', 'https://envs.sh/bNV.jpg https://envs.sh/bN-.jpg https://envs.sh/bN6.jpg https://envs.sh/bNx.jpg https://envs.sh/bHD.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://envs.sh/bHQ.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7251898668').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001855645227 -1002754048161').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002732889236'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002732889236'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002725001209'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002463332367').split()] #(make sure bot is admin)
...
# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', 'https://t.me/+EJLPwpeZpMJkODQ1')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
AUTH_CHANNELS = [int(channels_id) for channels_id in environ.get('AUTH_CHANNELS', '-1002827553840').split() if re.match(r'^-?\d+$', channels_id)]  # Channels for force sub (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'Contact The Owner')    # QR code image for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002714455064'))  # Notification of sent to your channel
...
VERIFY_IMG = environ.get("VERIFY_IMG", "https://envs.sh/bHw.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/how_to_open_link_ak")   # Tutorial link for verification
...
TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "0")) # Time gap for two-step verification in seconds (default: 20 minutes)
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "0"))    

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_seriesgroup') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TheRoronoaZoro') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/ZoroverseX') # Update channel link for the bot
