...
PICS = (environ.get('PICS', 'https://envs.sh/bNV.jpg https://telegra.ph/HgBotz-07-20 https://envs.sh/bN6.jpg https://envs.sh/bNx.jpg https://telegra.ph/HgBotz-07-20-2')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8252482448').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001855645227 -1001769437975 -1002754048161 -1002294594986 -1002370960281').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1002031749807')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
AUTH_CHANNELS = [int(channels_id) for channels_id in environ.get('AUTH_CHANNELS', '-1002779576540').split() if re.match(r'^-?\d+$', channels_id)]  # Channels for force sub (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'ask the owner')    # QR code image for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003511158512'))  # Notification of sent to your channel
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Ak_OwnerBot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/AkMovieVerse') # Update channel link for the bot
...
# ============================
# Server & Web Configuration (Fixed by ZeroDay)
# ============================
ON_HEROKU = 'DYNO' in environ
APP_NAME = environ.get('APP_NAME')

# Agar FQDN env mein nahi hai, toh default tera Koyeb URL use hoga
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '0.0.0.0'))
FQDN = str(getenv('FQDN', 'xenophobic-francisca-akmoviebotz-019ea95c.koyeb.app'))

# Heroku ke liye dynamic FQDN setup
