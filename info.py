...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5482682830').split()] # Replace with the actual admin ID(s) to add
...
# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1002331917822')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
